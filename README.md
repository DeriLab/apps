...
1. Clone the repo locally, via `git clone https://github.com/derilab/apps <optional local path>`
...
For more details on the desktop app, head over to [Electron package README](https://github.com/derilab/apps/blob/master/packages/apps-electron/README.md).
